...
import com.fanwen.yuefoodhome.adapter.ShopAdapter;
...
public class ShopFragment extends Fragment {
    ...
    private List<ShopBeen.DatasBean> list=new ArrayList<>();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        pullToRrefreshRecyclerView= (PullToRrefreshRecyclerView) getView().findViewById(R.id.rv_shopContent);
    ...
    private void initData() {
        stringRequest=new StringRequest(Request.Method.GET, String.format(url,page), new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                ShopBeen shopBeen=new Gson().fromJson(response,ShopBeen.class);
                list.add(shopBeen.getDatas());
